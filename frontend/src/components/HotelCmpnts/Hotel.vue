...
<body>
    ...
    <router-link to="/" class="navbar-brand ms-lg-5">
      <h1 class="m-0 text-uppercase text-dark"><i class="bi bi-shop fs-1 text-primary me-3"></i>Hotel del Resto Simulator</h1>
    </router-link>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <div class="navbar-nav ms-auto py-0">
        <router-link to="/" class="nav-item nav-link" :class="{ active: currentRoute === '/' }">Home</router-link>
        <router-link to="/service" class="nav-item nav-link" :class="{ active: currentRoute === '/service' }">Service</router-link>
        <router-link to="/restaurant" class="nav-item nav-link" :class="{ active: currentRoute === '/restaurant' }">Restaurant</router-link>
        <router-link to="/" class="nav-item nav-link nav-contact bg-primary text-white px-5 ms-lg-5">Log out <i class="bi bi-arrow-right"></i></router-link>
      </div>
    </div>
    </nav>
    <!-- Navbar End -->
...
export default {
  ...
  mounted() {
    ...
    customScript1.src = 'assets_admin/lib/easing/easing.min.js';

    const customScript2 = document.createElement('script');
    customScript2.src = 'assets_admin/lib/waypoints/waypoints.min.js';

    const customScript3 = document.createElement('script');
    customScript3.src = 'assets_admin/lib/owlcarousel/owl.carousel.min.js';

    const customScript4 = document.createElement('script');
    customScript4.src = 'assets_admin/js/main.js';
